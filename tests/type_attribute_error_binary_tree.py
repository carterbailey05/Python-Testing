#line 74 has type error, line 20 has runtime error attribute error
...
class Node:
    ...
    def __iter__(self) -> Iterator[int]:
        ...
        yield self.data
        if self.right:
            yield from self.righ #typo righ instead of right, attribute error/runtime
...
class BinaryTree:
    ...
    def medium_tree(cls) -> BinaryTree:
        ...
        six.right = Node("7") #type error, string instead of int
        return binary_tree
