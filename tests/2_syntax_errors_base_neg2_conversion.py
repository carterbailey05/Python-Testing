#missing closing bracket line 2, missing semi colon line 26
def decimal_to_negative_base_2(num: int -> int: #missing closing bracket after 1st int
    """
    ...
    if num == 0: 
        return 0
    ans = ""
    while num != 0 #missing semi colon 
