#Syntax errors on lines 31, 33, 70
...
class MarkovChainGraphUndirectedUnweighted:
    ...
    def transition(self, node: str) -> str #missing colon
        current_probability = 0
        random_value = random( #missing closing bracket
...
def get_transitions(
    ...
    for node1, node2, probability in transitions:
        graph.add_transition_probability(node1, probability) #missing middle argument, node2
