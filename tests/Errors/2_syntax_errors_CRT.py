#syntax errors on lines 20 and 75
"""
...
# Extended Euclid
def extended_euclid(a: int, b: int -> tuple[int, int]: #missing appropriate closing bracket after 'int'
    """
...
$ Same a above using InvertingModulo #incorrect comment
