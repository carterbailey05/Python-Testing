#syntax errors on lines 19, 36, 37
"""
...
def hexagonal_numbers(length: int) -> list[int] # missing ":"
    """
    ...
    if length <== 0 or not isinstance(length, int): #additional equals sign
        raise ValueError "Length must be a positive integer.") #missing opening bracket
